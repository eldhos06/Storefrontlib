...
public class DefaultStorefrontlibraryfacadesService implements StorefrontlibraryfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultStorefrontlibraryfacadesService.class);
	...
	{
		return DefaultStorefrontlibraryfacadesService.class.getResourceAsStream("/storefrontlibraryfacades/sap-hybris-platform.png");
	}
