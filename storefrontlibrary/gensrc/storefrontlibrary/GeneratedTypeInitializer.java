...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"PromotionProductRefinementComponent",
			"ProductRefinementComponent",
			org.storefrontlibrary.jalo.PromotionProductRefinementComponent.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"PromotionResultsGridComponent",
			"SearchResultsGridComponent",
			org.storefrontlibrary.jalo.PromotionResultsGridComponent.class,
			null,
			false,
			null,
			false
