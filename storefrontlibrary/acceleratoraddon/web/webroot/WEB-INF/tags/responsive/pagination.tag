...
<%@ taglib prefix="pagination" tagdir="/WEB-INF/tags/addons/storefrontlibrary/responsive" %>
<%@ taglib prefix="product" tagdir="/WEB-INF/tags/addons/storefrontlibrary/responsive" %>
